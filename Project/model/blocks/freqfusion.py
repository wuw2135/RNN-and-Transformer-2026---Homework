...
USE_MMCV_CARAFE = False  # 先關掉 mmcv 版
...
if __name__ == '__main__':
    ...
    hr_feat = torch.randn(1, 96, 16, 16).cuda()
    lr_feat = torch.randn(1, 96,  8,  8).cuda()
    model = FreqFusion(hr_channels=96, lr_channels=96).cuda()
